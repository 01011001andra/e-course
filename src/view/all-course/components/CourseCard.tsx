...
const CourseCard: React.FC<CardType> = ({
  ...
  return (
    <Link
      href={"/all-course/mastering-python-for-data-science"}
      className="flex flex-col border rounded-2xl shadow-lg"
    >
      ...
      <div className="p-6 flex flex-col justify-between gap-4 h-full">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className={`py-2 px-8 whitespace-nowrap text-sm border hover:bg-pink-800 bg-pink-600 text-white border-pink-600 font-semibold relative rounded-lg`}
          >
            Detail
          </button>
        </div>
